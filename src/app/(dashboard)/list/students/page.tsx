...
const StudentListPage = () => {
  ...
  const renderRow = (item: Student) => (
    ...
    >
      ...
      <td className="hidden md:table-cell font-mono text-xs text-gray-600">{item.studentId}</td>
      <td className="hidden md:table-cell font-semibold text-indigo-700">{item.grade}th Grade</td>
